...
var List = (function(t) {
  ...
  function(t, e) {
    ...
    t.exports = (function() {
      return function(t, e, s, a) {
        return (
          (a = a || {}),
          (a.test && a.getElementsByClassName) ||
          (!a.test && document.getElementsByClassName)
            ? r(t, e, s)
            : (a.test && a.querySelector) || (!a.test && document.querySelector)
            ? n(t, e, s)
            : i(t, e, s)
        );
      };
        ...
        r = {
          ...
          dottedRight: function(t, e, r, n, i, s, a) {
            return (
              ...
              (e == n && !this.innerWindow(e, i, s) && !this.right(e, n))
            );
          }
        },
        a = function(e, r, n) {
        ...
        r = function() {
          ...
          n
            ...
            : ((r = arguments[1] || r),
              ...
              (r.order = r.order || "asc"),
              (r.insensitive =
                "undefined" == typeof r.insensitive || r.insensitive)),
            e.clear(),
            e.setOrder(r);
          var i,
          ...
          if (r[n].data)
            ...
            r[n].attr && r[n].name
              ? ((s = t.utils.getByClass(e, r[n].name, !0)),
                s && s.setAttribute(r[n].attr, ""))
              : ((s = t.utils.getByClass(e, r[n], !0)),
                s && (s.innerHTML = ""));
          s = void 0;
        }
        return e;
            ...
            if (n[s].data)
              ...
              n[s].attr && n[s].name
                ? ((o = t.utils.getByClass(e.elm, n[s].name, !0)),
                  (i[n[s].name] = o ? t.utils.getAttribute(o, n[s].attr) : ""))
        ...
        (this.set = function(e, n) {
          var i = function(e) {
            ...
            s = function(r, n) {
              ...
              a &&
                (a.data
                  ? e.elm.setAttribute("data-" + a.data, n)
                  : a.attr && a.name
                  ? ((s = t.utils.getByClass(e.elm, a.name, !0)),
                    s && s.setAttribute(a.attr, n))
                  : ((s = t.utils.getByClass(e.elm, a, !0)),
                    s && (s.innerHTML = n)),
                (s = void 0));
            };
  ...
  function(t, e, r) {
    ...
    function i(t, e) {
      for (
        var r = (t += "").length, i = (e += "").length, s = 0, l = 0;
        s < r && l < i;
